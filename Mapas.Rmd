...
3. Quando criando o seu objeto sf, pode usar o argumento `remove=FALSE` para preservar as colunas de longitude e latitude explicitamente. Use essas duas colunas para adicionar mais uma camada de geometria que imprime os rótulos dos nomes das cidades ao seu mapa. 
...
4. Tirar os rótulos dos nomes das cidades e transforme os seus dados par a projeção com CRS 23035, e apresente um novo mapa.
...
5. Calcule o matriz da distância euclidiana entre os pontos.
