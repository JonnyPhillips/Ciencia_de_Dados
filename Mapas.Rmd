...
4. Quando criando o seu objeto sf, pode usar o argumento `remove=TRUE` para preservar as colunas de longitude e latitude explicitamente. Use essas duas colunas para adicionar mais uma camada de geometria que imprime os rótulos dos nomes das cidades ao seu mapa. 
