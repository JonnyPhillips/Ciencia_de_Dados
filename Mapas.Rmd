...
Para analisar estes dados como dados espaciais precisamos dizer ao R quais são as variáveis de localização. Isto exige uma nova biblioteca: `sf`, acrônimo para 'simple features', o nosso objeto espacial.
