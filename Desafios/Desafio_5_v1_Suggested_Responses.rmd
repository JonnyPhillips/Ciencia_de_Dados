...
7. Abre o shapefile no arquivo [MCMV_new.zip](https://raw.githubusercontent.com/JonnyPhillips/Ciencia_de_Dados/master/Desafios/MCMV_new.zip), que documenta a localização dos projetos de Minha Casa Minha Vida no Brasil, e o número de Unidades Habitacionais (UH) em cada projeto. 
...
19. Gere um 'wordcloud' dos stems das palavras usadas pelos Deputados.
...
20. Execute uma análise de sentimento para identificar no documento inteiro qual Deputado usa as palavras mais otimistas e qual Deputado usa as palavras mais pessimistas.
