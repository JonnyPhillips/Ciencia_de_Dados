...
<div class = "purple">
O prazo para entregar Desafio 2 por email com título “[FLS6397] - D2” à minha conta é **14h, 14/04/2020**, antes da aula. Por favor entregue (i) o arquivo .Rmd, e (ii) o arquivo .html.
</div>
...
5. Calcule a média e o desvio padrão do número de professores por escola em cada município (inclua uma tabela). Qual município há a maior variabilidade (desvio padrão) no número de professores por escola?
...
9. Usando o banco de dados 'longo' criado na questão 8:  
    (a) Calcule a média e o total do número de professores em cada nível de ensino *em cada município* (inclua uma tabela)
