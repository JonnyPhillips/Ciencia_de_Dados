...
Em **Knitr (com Latex)** o uso de bibliografias é: [EM MANUTENÇÃO]

<!-- * Salve o arquivo ".bib" na pasta do seu projeto. -->
<!-- * Antes de '\begin{document}' coloque `\usepackage{natbib}`.  -->
<!-- * No lugar apropriado no seu texto simples, quando quiser fazer referência à citação, insera `\cite{Arrow1961}`,  ou `\citep{Arrow1961}` se quiser parênteses, com o atalho apropriado para a citação desejada. -->
<!-- * No final do seu documento (imediatamente antes de '\end{document}'), coloque '\bibliography{nome_do_arquivo}' para o seu arquivo '.bib', (sem incluir '.bib').  -->
