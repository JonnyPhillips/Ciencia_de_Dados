...
* Uma restrição chata: Não podemos usar a botão de 'Compile in PDF'; temos que chamar a compilação em código no console (não no script), como no código abaixo, onde 'script.Rnw' é o nome do seu script (e não o arquivo da bibliografio):
