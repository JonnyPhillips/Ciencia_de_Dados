...
1. Introdução ao curso, R e Rmarkdown (06/03/20)
2. Abrindo e manipulando bancos de dados (13/03/20)
3. Organização e limpeza de dados (20/03/20)
4. Calculando estatísticas resumidas (27/03/20)
5. Construindo tabelas (03/04/20)
6. Visualização de dados e a gramática de gráficos (17/04/20)
7. Juntando bancos de dados (24/04/20)
8. Mapas e análises espaciais (08/05/20)
9. Testes estatísticos e modelos de regressão (15/05/20)
10. Produzindo relatórios reproduzíveis com Git e Latex (22/05/20)
11. Funções e repetição (29/05/20)
12. Mineração de Textos (05/06/20)
